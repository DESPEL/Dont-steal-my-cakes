...
bool DebugScene::init() {
	...
	***                                                            ***
	***                                                            ***
	*** HAY QUE REACOMODAR ESTO PARA QUE LEVEL RUN ACEPTE 2 PLAYER ***
	***                                                            ***
	***                                                            ***
	***                                                            ***
	***                                                            *** 
...
void DebugScene::update(float delta) {
	...
	***                                                            ***
	***                                                            ***
	*** Este es mi sistema de colisiones, revisar la nueva impleme ***
	*** tación (Hector)                                            ***
	***                                                            ***
	*** La dejo aquí comentada, solo para no borrarla              ***
	***                                                            *** 
	******************************************************************
	*/
